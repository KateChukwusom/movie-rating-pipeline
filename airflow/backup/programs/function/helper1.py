...
def get_data1_from_gdrive(file_id, s3_key, s3_bucket, conn_id):
...
if __name__ == "__main__":
        ...
        get_data1_from_gdrive(file_id="1-3S-XOgZyo9D3sVoXtjPvmFdsihjfQhN",
                              s3_key= "raw/data_movie_lens.csv", 
